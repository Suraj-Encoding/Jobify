                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-red-700 dark:text-red-300">You need at least 80% profile completion to post jobs. Current: <strong className={profileCompletion < 50 ? 'text-red-600' : profileCompletion < 80 ? 'text-yellow-600' : 'text-green-600'}>{profileCompletion}%</strong></p>
